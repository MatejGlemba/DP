...
class BlacklistDBHandler:
    ...
    def updateBlacklistData(self, key_value: str, newData: BlacklistData):
        self.__collection.update_one({blacklistCollectionKeys[0]: key_value}, {'$push' : {'data' : newData.__dict__}})
...
class MessagesDBHandler:
    ...
    def updateMessagesData(self, key_values, value):
        self.__collection.update_one({messagesCollectionKeys[0]: key_values[0], messagesCollectionKeys[1]: key_values[1]}, {'$push' : {'data' : value}})
    ...
    def updateMessagesDataForAllRooms(self, key_value, value):
        self.__collection.update_many({messagesCollectionKeys[1]: key_value}, {'$push' : {'data' : value}})
...
#         self.__collection.update_one({messagesCollectionKeys[0]: key_values[0], messagesCollectionKeys[1]: key_values[1]}, {'$set' : {'topics' : topics}})
